...
# ╔═╡ 4626d65b-0039-4187-b2ed-4f82349fab99
begin
	weather_file = CSV.File("./data/nyc/weather/request_results.csv")
	weather_data = DataFrame(weather_file)
end

# ╔═╡ c869ab25-41f7-45cb-9ada-738378e20011
